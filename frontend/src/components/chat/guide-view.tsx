...
const EXAMPLES = [
  {
    ...
    icon: Search,
    items: [
      { q: "중대재해처벌법 제4조 안전보건 확보 의무 알려줘", desc: "특정 법령의 조문을 검색합니다" },
      { q: "전자상거래법 청약철회 가능 기간은?", desc: "법령 내 특정 내용을 질문합니다" },
  ...
  },
  {
    ...
    icon: Scale,
    items: [
      { q: "성과급이 통상임금에 포함되는지 판례 찾아줘", desc: "실무 쟁점으로 대법원 판례를 검색합니다" },
      { q: "경업금지 약정의 효력 관련 대법원 판례", desc: "특정 법률 쟁점의 판례를 확인합니다" },
      { q: "카카오톡 대화 증거능력에 관한 판례", desc: "구체적인 주제로 판례를 찾습니다" },
    ],
  },
  {
    category: "계약서/규정 검토",
    ...
    <ScrollArea className="h-full">
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-[length:var(--text-2xl)] font-bold mb-2">Glluga 법령 Assistant</h1>
